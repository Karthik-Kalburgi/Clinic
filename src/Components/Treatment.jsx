...
const Treatment = () => {
  return (
    <div className="container mx-auto p-8 bg-sky-50 min-h-screen relative">
      ...
      <h1 className="absolute top-10  right-[40%] text-4xl  font-semibold font-poppins text-black z-15">
        Treatment Options
      </h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mt-32">
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-2xl hover:shadow-2xl transition duration-200">
          ...
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Heart Attack Therapies</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
            <li>• Angioplasty</li>
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold font-poppins text-center text-cyan-500">Heart Failure Therapies</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start   text-gray-700">
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Structural Heart Disease</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
            <li>• Valve</li>
            <li>• Mitraclip</li>
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Arrhythmia</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
            <li>• EP Study</li>
            <li>• RF Ablation</li>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mt-12">
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Syncope</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
            <li>• ELR</li>
            <li>• TILT test</li>
            <li>• Pacemaker/ICD</li>
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Stroke</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
            <li>• RF Ablation</li>
            <li>• LA appendage</li>
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center font-poppins text-cyan-500">Hypertension & Diabetic Related Heart Problems</h2>
        ...
        <div className="text-center bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition duration-200">
          <img
            ...
            className="w-full h-auto mb-4 rounded-md shadow-md"
          />
          <h2 className="text-2xl font-semibold text-center text-cyan-500">Aortic Disease</h2>
          <ul className="text-lg font-semibold font-poppins mt-2 text-start  text-gray-700">
