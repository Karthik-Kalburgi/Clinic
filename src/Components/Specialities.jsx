      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-12 px-6 py-12 bg-sky-50 rounded-3xl shadow-lg">
        ...
        <div className="space-y-4">
          <ul className="text-lg font-medium text-gray-800 list-disc pl-6">
            ...
            <li>✔️ Balloon Mitral Valvotomy</li>
            <li>✔️ Arrhythmia Treatments</li>
            <li>✔️ TAVI</li>
            <li>✔️ Coronary Angiogram</li>
            <li>✔️ Primary Angioplasty</li>
            <li>✔️ Permanent Pacemaker</li>
            <li>✔️ Cardiac Resynchronization Therapy</li>
