  ...
  return (
    <div className="relative">
      ...
      <img 
        ...
        className="w-full h-[500px] sm:h-[500px] md:h-[600px] lg:h-[700px] object-cover rounded-2xl"
      />
      
      {/* Overlay Section with Content */}
      <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center text-white p-4 sm:p-6 md:p-8">
